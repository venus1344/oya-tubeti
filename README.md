# Oya tubeti
This repo aims to implement a betting backend infrastructure that can handle multiple betters.
The BE shall be communicated with book makers to obtain odds for display. 
These odds shall be timely updated by an external trigger (TBD).
